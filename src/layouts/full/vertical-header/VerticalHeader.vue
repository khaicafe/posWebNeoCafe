...
<template>
    <v-app-bar elevation="0" :priority="priority" height="80" color="background"  id="top">
        <!-- <v-btn
        ...
        <!-- <div class="d-flex align-center justify-center mb-6"> -->
            <img src="@/assets/images/logos/favicon.svg" height="50"
        ...
        align-tabs="center"
        >
        <v-tab :value="1">Bán Hàng</v-tab>
        <v-tab :value="2">Đơn Hàng Online</v-tab>
        <v-tab :value="3">Đơn QR</v-tab>
        <v-tab :value="4">Nạp tiền</v-tab>
        <v-tab :value="5">Quản lý</v-tab>
        </v-tabs>
        <!-- ---------------------------------------------- -->
        <!-- Search part -->        <!-- ---------------------------------------------- -->
